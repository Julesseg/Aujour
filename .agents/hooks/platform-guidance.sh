...
target and the AujourUITests XCUITest suite cannot run on this machine. Exercise
...
the AujourUITests XCUITest suite cannot run on this machine. Implement UI work
